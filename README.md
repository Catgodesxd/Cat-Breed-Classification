...
- **Convolution** - 3×3 convolution, 40 filters, learns basic edges, color
...
- **Classifier** - Softmax, 15 nodes, 1 node for each breed
...
- **High-performing breeds include:**
  ...
  - Persian, Bombay, and Bengal - F1-scores above 0.9
...
dataset — an image of my own beloved cat. The model successfully predicted the correct breed
